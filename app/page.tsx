...
export default function Home() {
  return (
    <div className="h-screen flex justify-center items-center px-[20px]">
      <div className="hover:scale-[1.05] transition bg-black p-[20px] rounded-lg shadow-lg hover:shadow-xl">
        <h1 className="font-bold text-[20px] capitalize">welcome to the data fetching application</h1>
        <p className="text-[blue] mt-[8px]">Select a method to fetch data!</p>
